#ifndef CORENC_MESH_RegularMesh3D_h
#define CORENC_MESH_RegularMesh3D_h
#include "../Mesh.h"
...
namespace corenc
{
    namespace Mesh
    {
        class CRegularMesh3D// : public CMesh<>
        {
        public:
            CRegularMesh3D();
            ...
            {
                return new CRegularMesh3D(*this);
            };
...
#endif /* CORENC_MESH_RegularMesh3D_h */
